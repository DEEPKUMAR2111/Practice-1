    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if(!_roleManager.RoleExistsAsync(UserRole.Role_Admin).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(UserRole.Role_User)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(UserRole.Role_Employee)).GetAwaiter().GetResult();
            }
